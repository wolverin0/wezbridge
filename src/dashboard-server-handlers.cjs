...
function createHandlers({ sendJson, sendError, parseBody, log, corsHeaders }) {
// --- route handlers ---
...
/** Spawn a single agent pane through the IPC layer. */
...
function startBackgroundServices() {
  ...
  return {
    handleGetPanes, handleGetSessions, handleGetProjects, handleGetBrowse,
    handlePostBroadcast, handleGetPaneOutput, handleGetTasks, handleGetA2APending,
    handleGetGrades, handlePostGrade, handlePostA2AHandoff, handleEvents,
    handlePostPrompt, handlePostKey, handlePostKill, handlePostAutoHandoff,
    handleGetPersonas, handlePostSpawn, handleGetWorktrees, handlePostWorktreeCleanup,
    handlePostWorktreeMerge, handleGetPRDs, handleGetTeams, handlePostBootstrap,
    handleGetHandoffs, handlePostRoutinesFire, handleGetAutoHandoffPending,
    handlePostAutoHandoffSuppress, startAutoHandoffMonitor, startBackgroundServices,
  };
}
